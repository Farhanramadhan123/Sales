          ...
          <div className="bg-blue-50/50 p-4 rounded-xl border border-blue-100 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                      ...
                      <input type="number" name="adminFee" value={form.adminFee} onChange={handleChange} className="w-full px-3 py-2 border border-blue-200 rounded-lg text-right text-xs font-semibold focus:ring-2 focus:ring-blue-500 outline-none" />
                  </div>
              </div>
          </div>

          <div className="grid grid-cols-2 gap-3 pt-2">
              <input type="text" name="unitName" value={form.unitName} onChange={handleChange} className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all" placeholder="Nama Unit (Opsional)" />
              <input type="text" name="nopol" value={form.nopol} onChange={handleChange} className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all" placeholder="No. Polisi (Opsional)" />
          </div>
        </div>
      </div>
    </div>
